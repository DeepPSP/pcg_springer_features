...
try:
    from pcg_springer_features import get_schmidt_heart_rate, get_springer_features
...
def test_extract_features():
    ...
    assert springer_features.shape[0] == 4 * int(np.ceil(data.shape[0] / (fs / feature_fs)))
